...
public record UserContext(
    ...
    public static UserContext fromRequest(HttpServletRequest request) {
        ...
        if (userIdHeader == null || userIdHeader.isBlank()) {
            throw new BusinessException("UNAUTHORIZED", "Missing user authentication headers.", HttpStatus.UNAUTHORIZED);
        }
        ...
        if (roles.isEmpty()) {
            throw new BusinessException("UNAUTHORIZED", "Missing user role header.", HttpStatus.UNAUTHORIZED);
        }
