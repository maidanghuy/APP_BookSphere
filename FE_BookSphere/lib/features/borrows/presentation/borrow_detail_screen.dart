...
class BorrowDetailScreen extends ConsumerWidget {
  ...
  void _handleReturn(BuildContext context, WidgetRef ref) {
    ...
    showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(l10n.confirmReturnMessage),
        actions: [
          TextButton(
      ...
      if (confirmed == true) {
        ...
        if (success && context.mounted) {
          ...
          // Invalidate details to force reload
        ...
        data: (borrow) {
          ...
          return Column(
            children: [
              ...
              // Action Return Button Container
              if (canReturn) ...[
                SafeArea(
                  child: Container(
                    padding: const EdgeInsets.all(16),
                    ...
                    child: ElevatedButton(
                      onPressed: returnState.isLoading ? null : () => _handleReturn(context, ref),
